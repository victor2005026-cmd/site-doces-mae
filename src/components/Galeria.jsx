...
const ITEMS = [
  {
    src: '/images/galeria-kit.jpg',
    full: '/images/galeria-kit.jpg',
    alt: 'Kit de brigadeiros variados com caixinha decorada para presente',
  ...
  {
    src: '/images/galeria-finos.jpg',
    full: '/images/galeria-finos.jpg',
    alt: 'Doces finos brancos decorados com confete vermelho',
    caption: 'Doces finos decorados',
    local: true,
    tall: false,
  },
  {
  ...
  },
  {
    ...
    full: '/images/galeria-decoracao.jpg',
    alt: 'Confeitos coloridos decorativos em macro',
    caption: 'Decoração especial',
    local: true,
    tall: false,
  },
  {
  ...
  {
    src: '/images/galeria-trufas.jpg',
    full: '/images/galeria-trufas.jpg',
  ...
  },
  {
    ...
    full: '/images/galeria-tradicional.jpg',
    alt: 'Brigadeiro tradicional com granulado de chocolate',
    caption: 'Brigadeiro tradicional',
    local: true,
    tall: false,
  },
];
